...
float4 main(InputType input) : SV_TARGET
{
	...
	lightColour = ambientColour[0] + calculateLighting(-lightDirection[0], input.normal, diffuseColour[0]);

	//Transparent background
	if (textureColour.r > 0.6f && textureColour.b > 0.6f)
	{
		textureColour = float4(0.f, 0.f, 0.f, 0.f);
		//textureColour *= 0.f;
		//textureColour.a = 0.01f;
	}

	//return textureColour;
	return lightColour * textureColour;*/
	//return lightColour * input.colour;
